...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'elegant': '0 10px 40px -15px hsl(220 25% 5% / 0.8)',
        'glow': '0 0 40px hsl(38 75% 55% / 0.15)',
        'card': '0 4px 20px -4px hsl(220 25% 5% / 0.5)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(38 75% 55% / 0.2)" },
          "50%": { boxShadow: "0 0 40px hsl(38 75% 55% / 0.35)" },
        },
        "float": {
