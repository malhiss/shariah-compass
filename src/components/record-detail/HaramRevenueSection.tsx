// Revenue Composition Section with Donut Chart + Segment Accordion (Collapsible)
...
import { PieChart as PieChartIcon, ChevronDown, Info } from 'lucide-react';
          ...
          <CardHeader className="cursor-pointer hover:bg-muted/10 transition-colors">
            <CardTitle className="flex items-center justify-between text-lg">
              ...
              <div className="flex items-center gap-3">
                {/* Show halal/haram split when collapsed */}
                {!isOpen && (
                  <div className="flex items-center gap-4 mr-2">
                    <div className="flex items-center gap-1.5">
                      <div className="w-3 h-3 rounded-full bg-compliant" />
                      <span className="text-sm font-medium text-compliant">{halalPct.toFixed(1)}%</span>
                      <span className="text-xs text-muted-foreground">Halal</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <div className="w-3 h-3 rounded-full bg-non-compliant" />
                      <span className="text-sm font-medium text-non-compliant">{haramPct.toFixed(1)}%</span>
                      <span className="text-xs text-muted-foreground">Haram</span>
                    </div>
                  </div>
                )}
