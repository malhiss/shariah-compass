...
import { LogIn, Mail, Lock, ArrowLeft, Shield } from 'lucide-react';
...
export default function StaffLogin() {
  ...
  const { signIn, user, loading, isStaff } = useAuth();
      ...
      >
        <div className="text-center mb-8">
          <Link to="/" className="inline-block mb-6">
            <img src={dalilLogo} alt="Dalil" className="h-[7.5rem] w-auto mx-auto" />
          </Link>
        ...
        <Card className="border-border bg-card/80 backdrop-blur">
          <CardHeader className="text-center">
            <CardTitle className="text-xl font-serif">Staff Sign In</CardTitle>
            <CardDescription>
