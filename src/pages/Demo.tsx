  ...
  return (
    <>
      ...
      <section ref={heroRef} id="hero" className="relative min-h-[100vh] flex items-center py-24 lg:py-32 overflow-hidden">
        ...
        {/* Animated orbs - CSS on mobile, framer-motion on desktop */}
        {isMobile ? (
          ...
          <div className="container relative z-10 px-4 animate-fade-in">
            <div className="max-w-5xl mx-auto text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center mb-16">
                <Button 
                  size="lg" 
                  className="btn-dalil text-base h-14 px-10 group"
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="text-base h-14 px-10 border-primary/30 hover:bg-primary/10"
                  asChild
                >
                  <Link to="/demo/login">
